      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            <router-link to="/registeredCards">Card Registration</router-link>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            <router-link to="/kycAuthentication">KYC Authentication</router-link>              
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            <router-link to="policyDetails">Policy Details</router-link>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            <router-link to="/lostWalletRecords">Lost Wallet Records</router-link>
          </a>
        </li>
      </ul>
    </div>
